 ...
 */
@Deprecated
public class UserGroupPlugin extends org.imixs.marty.security.UserGroupPlugin {
    ...
    public ItemCollection run(ItemCollection adocumentContext, ItemCollection documentActivity) throws PluginException {
        logger.warning(
                "This DeputyPlugin is deprecated and should be replaced with 'org.imixs.marty.security.UserGroupPlugin'");
