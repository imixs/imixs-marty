 ...
 */
@Deprecated
public class ProfilePlugin extends org.imixs.marty.profile.ProfilePlugin {
    ...
    public ItemCollection run(ItemCollection adocumentContext, ItemCollection documentActivity) throws PluginException {
        logger.warning(
                "This ProfilePlugin is deprecated and should be replaced with 'org.imixs.marty.profile.ProfilePlugin'");
