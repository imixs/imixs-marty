...
/**
 * NOTE: This is a new draft version of the org.imixs.workflow.RulePlugin This
 * code will replace the orgin plugin after succesfull testing!
 * 
 * 
 ...
 * NEW BEHAVIOR:
 * 
 * if isValid=false then the plugin evalueats the params 'errorCode' and
 * errorMessage. 'errorMessage' can be an array of messages. If the
 * 'errorCode'=='VALIDATION_ERROR' then the error message will be added as
 * separate FacesErorrs Otherwise the erroe messages are handels as normal
 * params.
 * 
 * 
 * 
...
public class RulePlugin extends AbstractPlugin {
	...
	public static final String INVALID_ACTIVITY = "INVALID_ACTIVITY";
	...
	/**
	 * This method evaluates a script and test the object value 'isValid'.
	 * The documentContext is valid for the current activity if 'isValid' is not 'false'
	 * 
